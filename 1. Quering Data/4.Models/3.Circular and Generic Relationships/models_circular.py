...
class Collection(models.Model):
    ...
    # An error is showing that product class does not exist. This is because product is defined after collection class
    featured_product = models.ForeignKey('Product', on_delete=models.SET_NULL, null=True, related_name='+')
    # related_name='+' --> do not create a reverse relationship (also avoids field name clash)
